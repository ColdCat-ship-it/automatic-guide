...
(** This is the entry point to a series of electronic textbooks on
    ...
    property-based random testing, verification of practical C
    code, and security. The exposition is intended for a broad range of
...
(** If you prefer, there are several other ways to use Rocq. You will need:
    ...
    - An IDE for interacting with Rocq.  There are several choices:
        ...
        - _VsRocq_ is an extension for Visual Studio Code that offers a
          simple interface via a familiar IDE.  This option is the
          recommended default.

          VsRocq can be used as an ordinary IDE or it can be combined
...
(** If you want to refer to this volume in your own writing, please
    ...
    note         =   {Version 7.1, \URL{http://softwarefoundations.cis.upenn.edu}}
    }
*)
...
(** If you plan to use these materials in your own teaching, or if you
    ...
    record," as follows:
      ...
      - I hereby assign copyright in my past and future contributions
        ...
        is Arthur Chargueraud. For Volume 7, "Security Foundations," the
        author of record is Catalin Hritcu. For components outside of
